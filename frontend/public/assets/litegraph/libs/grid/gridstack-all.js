...
!function(e, t) {
    ...
    class i {
        static getElements(e, t=document) {
            if ("string" == typeof e) {
                ...
                return s.length || "." === e[0] || "#" === e[0] || (s = t.querySelectorAll("." + e),
        ...
        static getElement(e, t=document) {
            if ("string" == typeof e) {
                ...
                return i && !s && (s = i.getElementById(e)),
        ...
        static shouldSizeToContent(e, t=!1) {
            return e?.grid && (t ? !0 === e.sizeToContent || !0 === e.grid.opts.sizeToContent && void 0 === e.sizeToContent : !!e.sizeToContent || e.grid.opts.sizeToContent && !1 !== e.sizeToContent)
        }
        ...
        static createStylesheet(e, t, i) {
            ...
            t ? t.insertBefore(s, t.firstChild) : (t = document.getElementsByTagName("head")[0]).appendChild(s),
            s.sheet
        }
        ...
        static removeInternalAndSame(e, t) {
            if ("object" == typeof e && "object" == typeof t)
                for (let s in e) {
                    const o = e[s]
                      , n = t[s];
                    "_" === s[0] || o === n ? delete e[s] : o && "object" == typeof o && void 0 !== n && (i.removeInternalAndSame(o, n),
        ...
        static cloneDeep(e) {
            const t = ["parentGrid", "el", "grid", "subGrid", "engine"]
              , s = i.clone(e);
            for (const o in s)
                s.hasOwnProperty(o) && "object" == typeof s[o] && "__" !== o.substring(0, 2) && !t.find((e=>e === o)) && (s[o] = i.cloneDeep(e[o]));
            return s
        }
        static cloneNode(e) {
        ...
        static addElStyles(e, t) {
            if (t instanceof Object)
                for (const i in t)
                    t.hasOwnProperty(i) && (Array.isArray(t[i]) ? t[i].forEach((t=>{
                        e.style[i] = t
                    }
                    )) : e.style[i] = t[i])
        }
        ...
        static simulateMouseEvent(e, t, i) {
            ...
            s.initMouseEvent(t, !0, !0, window, 1, e.screenX, e.screenY, e.clientX, e.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, 0, e.target),
    ...
    class s {
        ...
        batchUpdate(e=!0, t=!0) {
            return !!this.batchMode === e || (this.batchMode = e,
        ...
        _fixCollisions(e, t=e, s, o={}) {
            if (this.sortNodes(-1),
            !(s = s || this.collide(e, t)))
                return !1;
            if (e._moving && !o.nested && !this.float && this.swap(e, s))
                return !0;
            let n = t;
            ...
            for (; s = s || this.collide(e, n, o.skip); ) {
                ...
                s.locked && n ? i.copyPos(t, e) : !s.locked && n && o.pack && (this._packNodes(),
                t.y = s.y + s.h,
                i.copyPos(e, t)),
                r = r || n) : n = this.moveNode(s, {
                    ...s,
                    y: t.y + t.h,
                    skip: e,
                    ...l
        ...
        directionCollideCoverage(e, t, i) {
            ...
            for (let e of i) {
                ...
                o.x < t.x ? l = (n.x + n.w - t.x) / t.w : o.x + o.w > t.x + t.w && (l = (t.x + t.w - n.x) / t.w);
                let h = Math.min(l, i);
                h > r && (r = h,
                s = e)
            }
        ...
        swap(e, t) {
            ...
            let o;
            if (e.w === t.w && e.h === t.h && (e.x === t.x || e.y === t.y) && (o = i.isTouching(e, t)))
                return s();
            if (!1 !== o) {
        ...
        set float(e) {
            this._float !== e && (this._float = e || !1,
            e || this._packNodes()._notify())
        }
        get float() {
            return this._float || !1
        }
        sortNodes(e=1) {
            return this.nodes = i.sort(this.nodes, e),
            this
        }
        _packNodes() {
            return this.batchMode || (this.sortNodes(),
            this.float ? this.nodes.forEach((e=>{
        ...
        nodeBoundFix(e, t) {
            ...
            if (e.maxW && (e.w = Math.min(e.w, e.maxW)),
            e.maxH && (e.h = Math.min(e.h, e.maxH)),
            e.minW && e.minW <= this.column && (e.w = Math.max(e.w, e.minW)),
            e.minH && (e.h = Math.max(e.h, e.minH)),
            (e.x || 0) + (e.w || 1) > this.column && this.column < 12 && !this._inColumnResize && e._id && -1 === this.findCacheLayout(e, 12)) {
                let t = {
                    ...e
                };
                t.autoPosition || void 0 === t.x ? (delete t.x,
                delete t.y) : t.x = Math.min(11, t.x),
                t.w = Math.min(12, t.w || 1),
                this.cacheOneLayout(t, 12)
            }
            return e.w > this.column ? e.w = this.column : e.w < 1 && (e.w = 1),
        ...
        restoreInitial() {
            return this.nodes.forEach((e=>{
                i.samePos(e, e._orig) || (i.copyPos(e, e._orig),
                e._dirty = !0)
            }
            )),
            this._notify(),
        ...
        findEmptyPosition(e, t=this.nodes, s=this.column, o) {
            ...
            for (let r = o ? o.y * s + (o.x + o.w) : 0; !n; ++r) {
                ...
                t.find((e=>i.isIntercepted(h, e))) || (e.x === o && e.y === l || (e._dirty = !0),
                e.x = o,
                e.y = l,
        ...
        addNode(e, t=!1, i) {
            let s;
            return this.nodes.find((t=>t._id === e._id)) || (this._inColumnResize ? this.nodeBoundFix(e) : this.prepareNode(e),
            delete e._temporaryRemoved,
            delete e._removeDOM,
            e.autoPosition && this.findEmptyPosition(e, this.nodes, this.column, i) && (delete e.autoPosition,
            s = !0),
            this.nodes.push(e),
        ...
        removeNode(e, t=!0, i=!1) {
            return this.nodes.find((t=>t._id === e._id)) ? (i && this.removedNodes.push(e),
            t && (e._removeDOM = !0),
        ...
        removeAll(e=!0, t=!0) {
            if (delete this._layouts,
            !this.nodes.length)
                return this;
            e && this.nodes.forEach((e=>e._removeDOM = !0));
            const i = this.nodes;
            return this.removedNodes = t ? i : [],
            this.nodes = [],
            this._notify(i)
        }
        moveNodeCheck(e, t) {
            ...
            if (!o)
                return !1;
            let r = n.moveNode(o, t) && n.getRow() <= Math.max(this.getRow(), this.maxRow);
        ...
        willItFit(e) {
            ...
            return this.cleanupNode(o),
            delete o.el,
            delete o._id,
            delete o.content,
            delete o.grid,
            t.addNode(o),
            t.getRow() <= this.maxRow && (e._willFitPos = i.copyPos({}, o),
            !0)
        }
        changedPosConstrain(e, t) {
            return t.w = t.w || e.w,
            t.h = t.h || e.h,
            e.x !== t.x || e.y !== t.y || (e.maxW && (t.w = Math.min(t.w, e.maxW)),
            ...
            if (l.length) {
                ...
                if (o && r && e.grid?.opts?.subGridDynamic && !e.grid._isTemp) {
                    let s = i.areaIntercept(t.rect, r._rect)
                      , o = i.area(t.rect)
                      , n = i.area(r._rect);
                    s / (o < n ? o : n) > .8 && (r.grid.makeSubGrid(r.el, void 0, e),
                    r = void 0)
                }
                r ? h = !this._fixCollisions(e, n, r, t) : (h = !1,
                s && delete t.pack)
            }
            return h && (e._dirty = !0,
            i.copyPos(e, n)),
        ...
        beginUpdate(e) {
            return e._updating || (e._updating = !0,
            delete e._skipDown,
            ...
            return !this._layouts || this._inColumnResize || this._layouts.forEach(((t,i)=>{
                ...
                if (i < this.column)
                    ...
                    e.forEach((e=>{
                        ...
                        i && (i.y >= 0 && e.y !== e._orig.y && (i.y += e.y - e._orig.y),
        ...
        columnChanged(e, t, s="moveScale") {
            ...
            if (t > e && this._layouts) {
                ...
                !i.length && e !== s && this._layouts[s]?.length && (e = s,
                this._layouts[s].forEach((e=>{
                    let t = r.find((t=>t._id === e._id));
                    t && (o || e.autoPosition || (t.x = e.x ?? t.x,
                    t.y = e.y ?? t.y),
                    t.w = e.w ?? t.w,
            ...
            if (o)
                ...
                if (r.length)
                    if ("function" == typeof s)
                        ...
                        r.forEach((s=>{
                            s.x = 1 === t ? 0 : l ? Math.round(s.x * i) : Math.min(s.x, t - 1),
                            s.w = 1 === t || 1 === e ? 1 : h ? Math.round(s.w * i) || 1 : Math.min(s.w, t),
                            n.push(s)
                        }
                        )),
                        r = []
            ...
            return this.nodes.forEach((e=>delete e._orig)),
        ...
        cacheOneLayout(e, t) {
            ...
            (e.autoPosition || void 0 === e.x) && (delete i.x,
            delete i.y,
            e.autoPosition && (i.autoPosition = !0)),
            this._layouts = this._layouts || [],
            this._layouts[t] = this._layouts[t] || [];
            let o = this.findCacheLayout(e, t);
            return -1 === o ? this._layouts[t].push(i) : this._layouts[t][o] = i,
            this
        }
        findCacheLayout(e, t) {
    ...
    function c(e) {
        h.touchHandled || (h.touchHandled = !0,
        a(e, "mousedown"))
    }
    function g(e) {
    ...
    function p(e) {
        if (!h.touchHandled)
            return;
        h.pointerLeaveTimeout && (window.clearTimeout(h.pointerLeaveTimeout),
    ...
    function f(e) {
        r.dragElement && "mouse" !== e.pointerType && (h.pointerLeaveTimeout = window.setTimeout((()=>{
            delete h.pointerLeaveTimeout,
            d(e, "mouseleave")
        }
        ), 10))
    ...
    class y {
        ...
        _init() {
            ...
            l && (this.el.addEventListener("touchstart", c),
        ...
        destroy() {
            ...
            l && (this.el.removeEventListener("touchstart", c),
        ...
        _mouseDown(e) {
            ...
            l && (this.el.addEventListener("touchmove", g),
        ...
        _mouseMove(e) {
            ...
            this.moving ? this._triggerEvent("move", e) : Math.abs(e.x - t.x) + Math.abs(e.y - t.y) > 2 && (this.moving = !0,
        ...
        _mouseUp(e) {
            ...
            l && (this.el.removeEventListener("touchmove", g),
        ...
        _keyEvent(e) {
            "Escape" === e.key && (this.host.gridstackNode?.grid?.engine.restoreInitial(),
            this._mouseUp(this.mouseDownEvent))
        }
        _triggerEvent(e, t) {
            return this.option[e] && this.option[e](t),
            this
        }
    }
    ...
    class v extends _ {
        ...
        _setupAutoHide(e) {
            return e ? (this.el.classList.add("ui-resizable-autohide"),
        ...
        _mouseOver(e) {
            r.overResizeElement || r.dragElement || (r.overResizeElement = this,
        ...
        _setupHandlers() {
            return this.handlers = this.option.handles.split(",").map((e=>e.trim())).map((e=>new y(this.el,e,{
                start: e=>{
                    this._resizeStart(e)
                }
                ,
        ...
        _resizeStart(e) {
            ...
            return this.option.start && this.option.start(t, this._ui()),
        ...
        _resizing(e, t) {
            ...
            return this.option.resize && this.option.resize(s, this._ui()),
        ...
        _setupHelper() {
            this.elOriginStyleVal = v._originStyleProp.map((e=>this.el.style[e])),
        ...
        _cleanHelper() {
            return v._originStyleProp.forEach(((e,t)=>{
        ...
        _constrainSize(e, t) {
            const i = this.option.maxWidth || Number.MAX_SAFE_INTEGER
              , s = this.option.minWidth / this.rectScale.x || e
              , o = this.option.maxHeight || Number.MAX_SAFE_INTEGER
              , n = this.option.minHeight / this.rectScale.y || t;
            return {
        ...
        _applyChange() {
            ...
            return this.temporalRect ? (Object.keys(this.temporalRect).forEach((t=>{
                const i = this.temporalRect[t]
                  , s = "width" === t || "left" === t ? this.rectScale.x : "height" === t || "top" === t ? this.rectScale.y : 1;
        ...
        _removeHandlers() {
            return this.handlers.forEach((e=>e.destroy())),
    ...
    class b extends _ {
        ...
        enable() {
            !1 !== this.disabled && (super.enable(),
            this.dragEl.addEventListener("mousedown", this._mouseDown),
            l && (this.dragEl.addEventListener("touchstart", c),
            this.dragEl.addEventListener("pointerdown", u)),
            this.el.classList.remove("ui-draggable-disabled"))
        }
        disable(e=!1) {
            !0 !== this.disabled && (super.disable(),
            this.dragEl.removeEventListener("mousedown", this._mouseDown),
            l && (this.dragEl.removeEventListener("touchstart", c),
            this.dragEl.removeEventListener("pointerdown", u)),
        ...
        _mouseDown(e) {
            if (!r.mouseHandled)
                return 0 !== e.button || e.target !== this.dragEl && e.target.closest('input,textarea,button,select,option,[contenteditable="true"],.ui-resizable-handle') || this.option.cancel && e.target.closest(this.option.cancel) || (this.mouseDownEvent = e,
                ...
                document.addEventListener("mouseup", this._mouseUp, !0),
                l && (this.dragEl.addEventListener("touchmove", g),
                this.dragEl.addEventListener("touchend", p)),
                e.preventDefault(),
        ...
        _mouseMove(e) {
            ...
            this.dragging)
                ...
                t ? r.dropElement = t.el.ddElement.ddDroppable : delete r.dropElement,
                this.helper = this._createHelper(e),
                this._setupHelperContainmentStyle(),
                this.dragTransform = i.getValuesFromTransformedElement(this.helperContainment),
        ...
        _mouseUp(e) {
            ...
            document.removeEventListener("mouseup", this._mouseUp, !0),
            l && (this.dragEl.removeEventListener("touchmove", g, !0),
            this.dragEl.removeEventListener("touchend", p, !0)),
            this.dragging) {
                delete this.dragging,
        ...
        _keyEvent(e) {
            ...
            const s = t.grid;
            if ("Escape" === e.key)
                t._origRotate && (t._orig = t._origRotate,
                ...
                if (t.w === t.h)
                    return;
                t._origRotate = t._origRotate || {
                    ...t._orig
                },
                delete t._moving,
                s.setAnimation(!1).rotate(t.el, {
        ...
        _createHelper(e) {
            ...
            document.body.contains(t) || i.appendTo(t, "parent" === this.option.appendTo ? this.el.parentElement : this.option.appendTo),
            t === this.el && (this.dragElementOriginStyle = b.originStyleProp.map((e=>this.el.style[e]))),
            t
        }
        _setupHelperStyle(e) {
        ...
        _removeHelperStyle() {
            ...
            if (!e?._isAboutToRemove && this.dragElementOriginStyle) {
                ...
                b.originStyleProp.forEach((t=>e.style[t] = this.dragElementOriginStyle[t] || null)),
        ...
        _dragFollow(e) {
            const t = this.helper.style
              , i = this.dragOffset;
            t.left = (e.clientX + i.offsetLeft - 0) * this.dragTransform.xScale + "px",
            t.top = (e.clientY + i.offsetTop - 0) * this.dragTransform.yScale + "px"
        }
        ...
        _getDragOffset(e, t, i) {
            let s = 0
              , o = 0;
            i && (s = this.dragTransform.xOffset,
            o = this.dragTransform.yOffset);
    ...
    class w extends _ {
        ...
        enable() {
            ...
            l && (this.el.addEventListener("pointerenter", m),
        ...
        disable(e=!1) {
            ...
            l && (this.el.removeEventListener("pointerenter", m),
        ...
        _mouseEnter(e) {
            if (!r.dragElement)
                return;
            if (!this._canDrop(r.dragElement.el))
                return;
            e.preventDefault(),
            e.stopPropagation(),
            r.dropElement && r.dropElement !== this && r.dropElement._mouseLeave(e, !0),
            r.dropElement = this;
            const t = i.initEvent(e, {
                target: this.el,
                type: "dropover"
        ...
        _mouseLeave(e, t=!1) {
            ...
            if (this.option.out && this.option.out(s, this._ui(r.dragElement)),
            this.triggerEvent("dropout", s),
            r.dropElement === this && (delete r.dropElement,
            !t)) {
                let t, i = this.el.parentElement;
                for (; !t && i; )
                    t = i.ddElement?.ddDroppable,
                    i = i.parentElement;
                t && t._mouseEnter(e)
            }
        }
        ...
        _setupAccept() {
            return this.option.accept ? ("string" == typeof this.option.accept ? this.accept = e=>e.classList.contains(this.option.accept) || e.matches(this.option.accept) : this.accept = this.option.accept,
            this) : this
        }
        _ui(e) {
            return {
    ...
    class E {
        static init(e) {
            return e.ddElement || (e.ddElement = new E(e)),
            e.ddElement
        }
        constructor(e) {
            this.el = e
        ...
        on(e, t) {
            return this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(e) > -1 ? this.ddDraggable.on(e, t) : this.ddDroppable && ["drop", "dropover", "dropout"].indexOf(e) > -1 ? this.ddDroppable.on(e, t) : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(e) > -1 && this.ddResizable.on(e, t),
            this
        }
        off(e) {
            return this.ddDraggable && ["drag", "dragstart", "dragstop"].indexOf(e) > -1 ? this.ddDraggable.off(e) : this.ddDroppable && ["drop", "dropover", "dropout"].indexOf(e) > -1 ? this.ddDroppable.off(e) : this.ddResizable && ["resizestart", "resize", "resizestop"].indexOf(e) > -1 && this.ddResizable.off(e),
            this
        }
        setupDraggable(e) {
            return this.ddDraggable ? this.ddDraggable.updateOption(e) : this.ddDraggable = new b(this.el,e),
            this
        }
        cleanDraggable() {
        ...
        setupResizable(e) {
            return this.ddResizable ? this.ddResizable.updateOption(e) : this.ddResizable = new v(this.el,e),
            this
        }
        cleanResizable() {
        ...
        setupDroppable(e) {
            return this.ddDroppable ? this.ddDroppable.updateOption(e) : this.ddDroppable = new w(this.el,e),
            this
        }
        cleanDroppable() {
    ...
    const x = new class {
        resizable(e, t, i, s) {
            return this._getDDElements(e).forEach((e=>{
                if ("disable" === t || "enable" === t)
                    ...
                    e.ddResizable && e.cleanResizable();
                else if ("option" === t)
                    e.setupResizable({
                        [i]: s
                    });
        ...
        draggable(e, t, i, s) {
            return this._getDDElements(e).forEach((e=>{
                if ("disable" === t || "enable" === t)
                    ...
                    e.ddDraggable && e.cleanDraggable();
                else if ("option" === t)
                    e.setupDraggable({
                        [i]: s
                    });
        ...
        dragIn(e, t) {
            return this._getDDElements(e).forEach((e=>e.setupDraggable(t))),
            this
        }
        droppable(e, t, i, s) {
            return "function" != typeof t.accept || t._accept || (t._accept = t.accept,
        ...
        off(e, t) {
            return this._getDDElements(e).forEach((e=>e.off(t))),
            this
        }
    ...
    class C {
        static init(e={}, t=".grid-stack") {
            ...
            return s ? (s.gridstack || (s.gridstack = new C(s,i.cloneDeep(e))),
            s.gridstack) : ("string" == typeof t ? console.error('GridStack.initAll() no grid was found with selector "' + t + '" - element missing or wrong selector ?\nNote: ".grid-stack" is required for proper CSS styling and drag/drop, and is the default selector.') : console.error("GridStack.init() no grid element was passed."),
            null)
        }
        static initAll(e={}, t=".grid-stack") {
            let s = [];
            return "undefined" == typeof document || (C.getGridElements(t).forEach((t=>{
        ...
        get placeholder() {
            if (!this._placeholder) {
                ...
                this._placeholder.classList.add(this.opts.placeholderClass, o.itemClass, this.opts.itemClass),
        ...
        constructor(e, t={}) {
            ...
            const a = t;
            if (a.oneColumnModeDomSort && (delete a.oneColumnModeDomSort,
            ...
            d && (d.columnWidth || d.breakpoints?.length ? d.columnMax = d.columnMax || 12 : (delete t.columnOpts,
            h = void 0)),
            ...
            e.getAttribute("gs-animate") && (c.animate = i.toBool(e.getAttribute("gs-animate"))),
            t = i.defaults(t, c),
            this._initMargin(),
            ...
            this._isAutoCellHeight || "initial" === t.cellHeight ? this.cellHeight(void 0, !1) : ("number" == typeof t.cellHeight && t.cellHeightUnit && t.cellHeightUnit !== o.cellHeightUnit && (t.cellHeight = t.cellHeight + t.cellHeightUnit,
            delete t.cellHeightUnit),
            this.cellHeight(t.cellHeight, !1)),
            "mobile" === t.alwaysShowResizeHandle && (t.alwaysShowResizeHandle = l),
            ...
            if (this.engine = new u({
                ...
                onChange: e=>{
                    ...
                    e.forEach((e=>{
                        ...
                        delete e._removeDOM) : this._writePosAttr(t, e))
                    }
                    )),
        ...
        addWidget(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                o?.el)
                    s = o.el;
                else if (C.addRemoveCB)
                    s = C.addRemoveCB(this.el, t, !0, !1);
                else {
                    let e = t?.content || ""
                      , i = document.implementation.createHTMLDocument("");
                    i.body.innerHTML = `<div class="grid-stack-item ${this.opts.itemClass || ""}"><div class="grid-stack-item-content">${e}</div></div>`,
                    s = i.body.children[0]
                }
            else
                s = e;
            ...
            if (!s)
                return;
            if (o = s.gridstackNode,
            o && s.parentElement === this.el && this.engine.nodes.find((e=>e._id === o._id)))
                return s;
            let r = this._readAttr(s);
            return t = i.cloneDeep(t) || {},
            i.defaults(t, r),
        ...
        makeSubGrid(e, t, s, o=!0) {
            ...
            let l, h = this;
            for (; h && !n; )
                n = h.opts?.subGridOpts,
                h = h.parentGridItem?.grid;
            t = i.cloneDeep({
                ...n || {},
                children: void 0,
                ...t || r.subGridOpts || {}
            ...
            delete t.columnOpts);
            let a, d, c = r.el.querySelector(".grid-stack-item-content");
            if (o) {
                if (this._removeDD(r.el),
                d = {
                    ...r,
                    x: 0,
                    y: 0
            ...
            return s?._moving && (g._isTemp = !0),
            l && (g._autoColumn = !0),
            o && g.addWidget(a, d),
            s && (s._moving ? window.setTimeout((()=>i.simulateMouseEvent(s._event, "mouseenter", g.el)), 0) : g.addWidget(r.el, r)),
            g
        }
        removeAsSubGrid(e) {
            ...
            e && window.setTimeout((()=>i.simulateMouseEvent(e._event, "mouseenter", t.el)), 0))
        }
        ...
        load(e, t=C.addRemoveCB || !0) {
            ...
            let o = e.filter((e=>(void 0 === e.x || void 0 === e.y) && !i.find(this.engine.nodes, e.id)));
            o.length && o.length !== e.length ? e = e.filter((e=>!i.find(o, e.id))) : o = [];
            const n = e.some((e=>void 0 !== e.x || void 0 !== e.y));
            n && (e = i.sort(e, -1)),
            this._insertNotAppend = n,
            e.some((e=>(e.x || 0) + (e.w || 1) > s)) && (this._ignoreLayoutsNodeChange = !0,
            this.engine.cacheLayout(e, 12, !0));
            const r = C.addRemoveCB;
            "function" == typeof t && (C.addRemoveCB = t);
            let l = [];
            this.batchUpdate();
            const h = !this.engine.nodes.length;
            h && this.setAnimation(!1),
            t && [...this.engine.nodes].forEach((t=>{
                t.id && (i.find(e, t.id) || (C.addRemoveCB && C.addRemoveCB(this.el, t, !1, !1),
                l.push(t),
                this.removeWidget(t.el, !0, !1)))
            }
            ));
            let a = [];
            return this.engine.nodes = this.engine.nodes.filter((t=>!i.find(e, t.id) || (a.push(t),
            !1))),
            e.forEach((e=>{
                let s = i.find(a, e.id);
                if (s) {
                    if (i.shouldSizeToContent(s) && (e.h = s.h),
                    this.engine.nodeBoundFix(e),
                    (e.autoPosition || void 0 === e.x || void 0 === e.y) && (e.w = e.w || s.w,
                    e.h = e.h || s.h,
                    this.engine.findEmptyPosition(e)),
                    this.engine.nodes.push(s),
                    i.samePos(s, e) && this.moveNode(s, {
                        ...e,
                        forceCollide: !0
                    }),
                    this.update(s.el, e),
            ...
            t && o.forEach((e=>this.addWidget(e))),
            this.engine.removedNodes = l,
            this.batchUpdate(!1),
            delete this._ignoreLayoutsNodeChange,
            delete this._insertNotAppend,
            r ? C.addRemoveCB = r : delete C.addRemoveCB,
            h && this.opts?.animate && this.setAnimation(this.opts.animate, !0),
            this
        }
        batchUpdate(e=!0) {
            return this.engine.batchUpdate(e),
            e || (this._updateContainerHeight(),
        ...
        getCellHeight(e=!1) {
            if (this.opts.cellHeight && "auto" !== this.opts.cellHeight && (!e || !this.opts.cellHeightUnit || "px" === this.opts.cellHeightUnit))
        ...
        cellHeight(e, t=!0) {
            if (t && void 0 !== e && this._isAutoCellHeight !== ("auto" === e) && (this._isAutoCellHeight = "auto" === e,
            this._updateResizeEvent()),
            ...
            return this.opts.cellHeightUnit === s.unit && this.opts.cellHeight === s.h || (this.opts.cellHeightUnit = s.unit,
        ...
        checkDynamicColumn() {
            ...
            if (i !== t) {
                ...
                return this.column(i, t?.layout || e.layout),
                !0
            }
            return !1
        }
        compact(e="compact", t=!0) {
            return this.engine.compact(e, t),
            this._triggerChangeEvent(),
            this
        }
        column(e, t="moveScale") {
            ...
            return this.opts.column = e,
            this.engine ? (this.engine.column = e,
        ...
        float(e) {
            return this.opts.float !== e && (this.opts.float = this.engine.float = e,
            this._triggerChangeEvent()),
            this
        }
        getFloat() {
        ...
        on(e, t) {
            ...
            if ("change" === e || "added" === e || "removed" === e || "enable" === e || "disable" === e) {
                ...
                "drag" === e || "dragstart" === e || "dragstop" === e || "resizestart" === e || "resize" === e || "resizestop" === e || "dropped" === e || "resizecontent" === e ? this._gsEventHandler[e] = t : console.error("GridStack.on(" + e + ") event not supported");
            return this
        }
        off(e) {
            return -1 !== e.indexOf(" ") ? (e.split(" ").forEach((e=>this.off(e))),
            this) : ("change" !== e && "added" !== e && "removed" !== e && "enable" !== e && "disable" !== e || this._gsEventHandler[e] && this.el.removeEventListener(e, this._gsEventHandler[e]),
            delete this._gsEventHandler[e],
            this)
        }
        offAll() {
            return Object.keys(this._gsEventHandler).forEach((e=>this.off(e))),
            this
        }
        removeWidget(e, t=!0, i=!0) {
            return C.getElements(e).forEach((e=>{
                if (e.parentElement && e.parentElement !== this.el)
                    return;
                let s = e.gridstackNode;
                s || (s = this.engine.nodes.find((t=>e === t.el))),
                s && (t && C.addRemoveCB && C.addRemoveCB(this.el, s, !1, !1),
        ...
        setAnimation(e=this.opts.animate, t) {
            ...
            )) : e ? this.el.classList.add("grid-stack-animate") : this.el.classList.remove("grid-stack-animate"),
            this
        }
        hasAnimationCSS() {
        ...
        setStatic(e, t=!0, i=!0) {
            return !!this.opts.staticGrid === e || (e ? this.opts.staticGrid = !0 : delete this.opts.staticGrid,
            this._setupRemoveDrop(),
            this._setupAcceptWidget(),
        ...
        update(e, t) {
            ...
            return C.getElements(e).forEach((e=>{
                ...
                if (!s)
                    return;
                let o = i.cloneDeep(t);
                this.engine.nodeBoundFix(o),
                delete o.autoPosition,
                delete o.id;
                let n, r = ["x", "y", "w", "h"];
                if (r.some((e=>void 0 !== o[e] && o[e] !== s[e])) && (n = {},
                r.forEach((e=>{
                    n[e] = void 0 !== o[e] ? o[e] : s[e],
                    delete o[e]
                }
                ))),
                ...
                void 0 !== o.content) {
                    ...
                    s.subGrid?.el && (t.appendChild(s.subGrid.el),
                ...
                let l = !1
                  , h = !1;
                for (const e in o)
                    "_" !== e[0] && s[e] !== o[e] && (s[e] = o[e],
                    l = !0,
                    h = h || !this.opts.staticGrid && ("noResize" === e || "noMove" === e || "locked" === e));
                if (i.sanitizeMinMax(s),
                n) {
        ...
        moveNode(e, t) {
            ...
            i || (this._triggerChangeEvent(),
            this.engine.endUpdate())
        }
        resizeToContent(e) {
            if (!e)
                return;
            if (e.classList.remove("size-to-content-max"),
            !e.clientHeight)
                return;
            ...
            if (!s)
                return;
            let o, n = t.h ? t.h * s : e.clientHeight;
            if (t.resizeToContentParent && (o = e.querySelector(t.resizeToContentParent)),
            ...
            if (t.subGrid)
                ...
                if (!e)
                    return void console.error(`Error: GridStack.resizeToContent() widget id:${t.id} '${C.resizeToContentParent}'.firstElementChild is null, make sure to have a div like container. Skipping sizing.`);
            ...
            a !== t.h && (i._ignoreLayoutsNodeChange = !0,
            i.moveNode(t, {
                h: a
            }),
            ...
            return C.getElements(e).forEach((e=>{
                ...
                if (t) {
                    let e = t.left > 0 ? Math.floor(t.left / this.cellWidth()) : 0
                      , o = t.top > 0 ? Math.floor(t.top / this.opts.cellHeight) : 0;
                    s.x = i.x + e - (i.h - (o + 1)),
                    s.y = i.y + o - e
                }
                this.update(e, s)
        ...
        _removeStylesheet() {
            if (this._styles) {
                ...
                i.removeStylesheet(this._styleSheetClass, e),
                delete this._styles
            }
            return this
        }
        _updateStyles(e=!1, t) {
            if (e && this._removeStylesheet(),
            ...
            if (!this._styles) {
                ...
                i.addCSSRule(this._styles, a, `top: ${t}; right: ${l}; bottom: ${r}; left: ${h};`),
                i.addCSSRule(this._styles, d, `top: ${t}; right: ${l}; bottom: ${r}; left: ${h};`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-n`, `top: ${t};`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-s`, `bottom: ${r}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-ne`, `right: ${l}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-e`, `right: ${l}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-se`, `right: ${l}; bottom: ${r}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-nw`, `left: ${h}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-w`, `left: ${h}`),
                i.addCSSRule(this._styles, `${n} > .ui-resizable-sw`, `left: ${h}; bottom: ${r}`)
            }
            if ((t = t || this._styles._max) > this._styles._max) {
                let e = e=>s * e + o;
                for (let s = this._styles._max + 1; s <= t; s++)
                    i.addCSSRule(this._styles, `${n}[gs-y="${s}"]`, `top: ${e(s)}`),
                    i.addCSSRule(this._styles, `${n}[gs-h="${s + 1}"]`, `height: ${e(s + 1)}`);
                this._styles._max = t
            }
            return this
        }
        _updateContainerHeight() {
            ...
            return this.el.setAttribute("gs-current-row", String(t)),
            this.el.style.removeProperty("min-height"),
            this.el.style.removeProperty("height"),
            t && (this.el.style[e ? "minHeight" : "height"] = t * s + o),
            e && !e.grid.engine.batchMode && i.shouldSizeToContent(e) && e.grid.resizeToContentCBCheck(e.el),
            this
        }
        _prepareElement(e, t=!1, s) {
            ...
            return n ? e.classList.add("size-to-content") : e.classList.remove("size-to-content"),
            n && this.resizeToContentCheck(!1, s),
            this._prepareDragDropByNode(s),
            this
        }
        _writePosAttr(e, t) {
            return void 0 !== t.x && null !== t.x && e.setAttribute("gs-x", String(t.x)),
        ...
        _readAttr(e, t=!0) {
            ...
            t && (1 === s.w && e.removeAttribute("gs-w"),
        ...
        _setStaticClass() {
            ...
            this.el.setAttribute("gs-static", "true")) : (this.el.classList.remove(...e),
        ...
        onResize() {
            ...
            this.batchUpdate();
            let e = !1;
            return this._autoColumn && this.parentGridItem ? this.opts.column !== this.parentGridItem.w && (this.column(this.parentGridItem.w, "none"),
            e = !0) : e = this.checkDynamicColumn(),
            this._isAutoCellHeight && this.cellHeight(),
            this.engine.nodes.forEach((e=>{
        ...
        resizeToContentCheck(e=!1, t=undefined) {
            if (this.engine) {
                ...
                if (t)
                    i.shouldSizeToContent(t) && this.resizeToContentCBCheck(t.el);
        ...
        _updateResizeEvent(e=!1) {
            const t = !this.parentGridItem && (this._isAutoCellHeight || this.opts.sizeToContent || this.opts.columnOpts || this.engine.nodes.find((e=>e.sizeToContent)));
            return e || !t || this.resizeObserver ? !e && t || !this.resizeObserver || (this.resizeObserver.disconnect(),
            delete this.resizeObserver,
            delete this._sizeThrottle) : (this._sizeThrottle = i.throttle((()=>this.onResize()), this.opts.cellHeightThrottle),
        ...
        _initMargin() {
            let e, t = 0, s = [];
            return "string" == typeof this.opts.margin && (s = this.opts.margin.split(" ")),
            2 === s.length ? (this.opts.marginTop = this.opts.marginBottom = s[0],
            this.opts.marginLeft = this.opts.marginRight = s[1]) : 4 === s.length ? (this.opts.marginTop = s[0],
            this.opts.marginRight = s[1],
            this.opts.marginBottom = s[2],
            this.opts.marginLeft = s[3]) : (e = i.parseHeight(this.opts.margin),
            this.opts.marginUnit = e.unit,
            t = this.opts.margin = e.h),
            void 0 === this.opts.marginTop ? this.opts.marginTop = t : (e = i.parseHeight(this.opts.marginTop),
            this.opts.marginTop = e.h,
            delete this.opts.margin),
            void 0 === this.opts.marginBottom ? this.opts.marginBottom = t : (e = i.parseHeight(this.opts.marginBottom),
            this.opts.marginBottom = e.h,
            delete this.opts.margin),
            void 0 === this.opts.marginRight ? this.opts.marginRight = t : (e = i.parseHeight(this.opts.marginRight),
            this.opts.marginRight = e.h,
            delete this.opts.margin),
            void 0 === this.opts.marginLeft ? this.opts.marginLeft = t : (e = i.parseHeight(this.opts.marginLeft),
        ...
        movable(e, t) {
            return this.opts.staticGrid || C.getElements(e).forEach((e=>{
        ...
        enable(e=!0) {
            if (!this.opts.staticGrid)
                return this.enableMove(!0, e),
                this.enableResize(!0, e),
                this._triggerEvent("enable"),
                this
        }
        enableMove(e, t=!0) {
            return this.opts.staticGrid || (e ? delete this.opts.disableDrag : this.opts.disableDrag = !0,
        ...
        enableResize(e, t=!0) {
            return this.opts.staticGrid || (e ? delete this.opts.disableResize : this.opts.disableResize = !0,
            this.engine.nodes.forEach((i=>{
                this._prepareDragDropByNode(i),
        ...
        _removeDD(e) {
            return x.draggable(e, "destroy").resizable(e, "destroy"),
        ...
        _setupAcceptWidget() {
            if (this.opts.staticGrid || !this.opts.acceptWidgets && !this.opts.removable)
                return x.droppable(this.el, "destroy"),
                this;
            let e, t, s = (s,o,n)=>{
                ...
                !r.grid?.el) {
                    ...
                    n.style.left = e.x + (this.dragTransform.xScale - 1) * (s.clientX - e.x) / this.dragTransform.xScale + "px",
                    n.style.top = e.y + (this.dragTransform.yScale - 1) * (s.clientY - e.y) / this.dragTransform.yScale + "px",
                ...
                if (r._temporaryRemoved) {
                    if (r.x = Math.max(0, Math.round(a / t)),
                    ...
                    !this.engine.willItFit(r)) {
                        ...
                        r._willFitPos && (i.copyPos(r, r._willFitPos),
                        delete r._willFitPos)
                    }
                    this._onStartMoving(n, s, d, r, t, e)
                } else
                    this._dragOrResize(n, s, d, r, t, e)
            }
            ;
            return x.droppable(this.el, {
                ...
                if (r?.grid === this && !r._temporaryRemoved)
                    return !1;
                r?.grid && r.grid !== this && !r._temporaryRemoved && r.grid._leave(o, n),
                t = this.cellWidth(),
                ...
                return !!s && (s.grid && s.grid !== this || (this._leave(t, i),
                ...
                n && l?.grid && l.grid !== this) {
                    let e = l.grid;
                    e.engine.removeNodeFromLayoutCache(l),
                    e.engine.removedNodes.push(l),
                    e._triggerRemoveEvent()._triggerChangeEvent(),
                    e.parentGridItem && !e.engine.nodes.length && e.opts.subGridDynamic && e.removeAsSubGrid()
                }
                if (!o)
                    return !1;
                if (n && (this.engine.cleanupNode(o),
                o.grid = this),
                delete o.grid?._isTemp,
                x.off(t, "drag"),
                s !== t ? (s.remove(),
                t.gridstackNode = l,
                n && (t = t.cloneNode(!0))) : (t.remove(),
                this._removeDD(t)),
                !n)
                    return !1;
                t.gridstackNode = o,
                ...
                return i.copyPos(o, this._readAttr(this.placeholder)),
                i.removePositioningStyles(t),
                this.el.appendChild(t),
                this._prepareElement(t, !0, o),
                h && (h.parentGridItem = o,
        ...
        static _itemRemoving(e, t) {
            ...
            i?.grid && !e.classList.contains(i.grid.opts.removableOptions.decline) && (t ? i._isAboutToRemove = !0 : delete i._isAboutToRemove,
            t ? e.classList.add("grid-stack-item-removing") : e.classList.remove("grid-stack-item-removing"))
        }
        _setupRemoveDrop() {
            if ("string" != typeof this.opts.removable)
                return this;
            let e = document.querySelector(this.opts.removable);
            return e ? (this.opts.staticGrid || x.isDroppable(e) || x.droppable(e, this.opts.removableOptions).on(e, "dropover", ((e,t)=>C._itemRemoving(t, !0))).on(e, "dropout", ((e,t)=>C._itemRemoving(t, !1))),
            this) : this
        }
        _prepareDragDropByNode(e) {
            ...
            if (this.opts.staticGrid || s && o)
                return e._initDD && (this._removeDD(t),
                delete e._initDD),
                ...
                , l = s=>{
                    ...
                    if (n.gridstackNode && n.gridstackNode.grid === this) {
                        ...
                        e._isAboutToRemove) {
                            ...
                            e._temporaryRemoved ? (i.copyPos(e, e._orig),
                            this._writePosAttr(n, e),
                            this.engine.addNode(e)) : this._writePosAttr(n, e),
                            this._gsEventHandler[s.type] && this._gsEventHandler[s.type](s, n);
                        this._extraDragRow = 0,
                        this._updateContainerHeight(),
                        this._triggerChangeEvent(),
                        this.engine.endUpdate(),
                        "resizestop" === s.type && (Number.isInteger(e.sizeToContent) && (e.sizeToContent = e.h),
            ...
            return x.draggable(t, s ? "disable" : "enable").resizable(t, o ? "disable" : "enable"),
            this
        }
        _onStartMoving(e, t, s, o, n, r) {
            if (this.engine.cleanNodes().beginUpdate(o),
            ...
            delete o._lastTried,
            "dropover" === t.type && o._temporaryRemoved && (this.engine.addNode(o),
            o._moving = !0),
            this.engine.cacheRects(n, r, this.opts.marginTop, this.opts.marginRight, this.opts.marginBottom, this.opts.marginLeft),
            "resizestart" === t.type && (x.resizable(e, "option", "minWidth", n * Math.min(o.minW || 1, this.getColumn() - o.x)).resizable(e, "option", "minHeight", r * Math.min(o.minH || 1, (this.opts.maxRow || Number.MAX_SAFE_INTEGER) - o.y)),
            o.maxW && x.resizable(e, "option", "maxWidth", n * o.maxW),
            o.maxH && x.resizable(e, "option", "maxHeight", r * o.maxH))
        }
        _dragOrResize(e, t, s, o, n, r) {
            let l, h = {
                ...o._orig
            }, a = this.opts.marginLeft, d = this.opts.marginRight, c = this.opts.marginTop, g = this.opts.marginBottom, p = Math.round(.1 * r), u = Math.round(.1 * n);
            if (a = Math.min(a, u),
            d = Math.min(d, u),
            c = Math.min(c, p),
            g = Math.min(g, p),
            "drag" === t.type) {
                ...
                o._prevYPix = s.position.top,
                !1 !== this.opts.draggable.scroll && i.updateScrollPosition(e, s.position, t);
                let l = s.position.left + (s.position.left > o._lastUiPosition.left ? -d : a)
                  , p = s.position.top + (s.position.top > o._lastUiPosition.top ? -g : c);
                h.x = Math.round(l / n),
                h.y = Math.round(p / r);
                ...
                if (this.engine.collide(o, h)) {
                    ...
                    this.opts.maxRow && e + t > this.opts.maxRow && (t = Math.max(0, this.opts.maxRow - e)),
        ...
        _leave(e, t) {
            let i = e.gridstackNode;
            i && ((t = t || e).style.transform = "scale(1)",
            x.off(e, "drag"),
        ...
        commit() {
            return this.batchUpdate(!1).prototype,
            this
        }
    }
    return C.resizeToContentParent = ".grid-stack-item-content",
    C.Utils = i,
    C.Engine = s,
    C.GDRev = "10.2.0",
    t.GridStack
